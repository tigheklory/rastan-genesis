-- Read-only Build 0354 VBlank audit using debugger PC breakpoints.
...
local function action(name)
    return string.format(
        'printf "B354,%s,%%d,%%d,%%d,%%04X,%%04X,%%04X,%%04X,%%04X,%%04X,%%04X,%%04X\\n",frame,beamy,beamx,w@FF0000,w@FF0002,w@FF0004,w@FFB884,w@FFBF70,w@FFB740,d4,d6; g',
        name)
end
...
local points = {
    ...
    {0x073EEC, "SPRITE_ENTRY"},
    {0x073F28, "SPRITE_TILE_ENTRY"}, {0x073F88, "PATTERN_DMA_CALL"}, {0x073F8C, "PATTERN_DMA_END"},
    {0x073EF4, "SPRITE_TILE_END"},
    {0x073E6C, "SPRITE_PALETTE_ENTRY"}, {0x073F18, "SPRITE_PALETTE_END"},
    {0x073FD2, "SPRITE_SAT_ENTRY"}, {0x073F1C, "SPRITE_SAT_END"},
...
for _, point in ipairs(points) do set_breakpoint(point[1], point[2]) end

-- Dump the complete bounded 12-entry worklist at sprite-commit entry, before reset.
cpu.debug:bpset(0x073EEC, "1",
    'printf "B354W,%d,%04X,%04X,%04X,%04X,%04X,%04X,%04X,%04X,%04X,%04X,%04X,%04X,%04X,%04X,%04X,%04X,%04X,%04X,%04X,%04X,%04X,%04X,%04X,%04X\\n",frame,w@FFB854,w@FFB856,w@FFB858,w@FFB85A,w@FFB85C,w@FFB85E,w@FFB860,w@FFB862,w@FFB864,w@FFB866,w@FFB868,w@FFB86A,w@FFB86C,w@FFB86E,w@FFB870,w@FFB872,w@FFB874,w@FFB876,w@FFB878,w@FFB87A,w@FFB87C,w@FFB87E,w@FFB880,w@FFB882; g')
