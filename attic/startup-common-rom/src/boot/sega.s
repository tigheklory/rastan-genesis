...
_Vecteurs_68K:
        ...
        dc.l    genesistan_Bus_Error
        dc.l    genesistan_Address_Error
        dc.l    genesistan_Illegal_Instruction
        dc.l    genesistan_Zero_Divide
        dc.l    genesistan_Chk_Instruction
        dc.l    genesistan_Trapv_Instruction
        dc.l    genesistan_Privilege_Violation
        dc.l    genesistan_Trace
        dc.l    genesistan_Line_1010_Emulation
        dc.l    genesistan_Line_1111_Emulation
        dc.l     genesistan_Error_Exception, genesistan_Error_Exception, genesistan_Error_Exception, genesistan_Error_Exception
        dc.l     genesistan_Error_Exception, genesistan_Error_Exception, genesistan_Error_Exception, genesistan_Error_Exception
        dc.l     genesistan_Error_Exception, genesistan_Error_Exception, genesistan_Error_Exception, genesistan_Error_Exception
        dc.l    genesistan_Error_Exception
        dc.l    _INT
        dc.l    _EXTINT
        dc.l    _INT
        dc.l    hintCaller
