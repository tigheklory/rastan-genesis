...
- **Path `0x055E54`** (guard `a5@(5034)=a5@0x13AA`, absolute 0x10D3AA, `==2`): `movel #0xC00400, a5@(4256)` → sets the strip_A cursor to **`pc080sn_tilemap0_0xC00000`**. This is **one proven** tilemap-0 cursor setup, distinct from the gameplay triggers. It does **not** prove this is the only tilemap-0 producer; the complete tilemap-0 producer set remains unresolved (see unresolved.md).
